...
const Hero = ({ handleAvatarBlue, handleAvatarCoding, active }) => (
...
const updatePolygonArrays = idToAnimateTo => {
  const toPolygonArray = createPolygonPointsObject(
    document.getElementById(idToAnimateTo).querySelectorAll('polygon')
  )
...
export default compose(withState('active', 'setActive', null), withLifecycle)(
  Hero
)
